<?php
	...
	$i18n['fished-confirmation'] = 'N&uacute;mero de confirmaci&oacute;n';
	$i18n['fished-price'] = 'Cantidad';
	$i18n['fished-tracking'] = 'N&uacute;mero de seguimiento';	

	// gift content
	$i18n['fished-inside'] = 'Su regalo por dentro';
?>