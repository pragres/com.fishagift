...
<div id="section-body" class="container">
	...
	<div class="col-lg-4 col-md-5 col-sm-6 hidden-xs text-right">
		<img style="border:1px solid black;" src="https://maps.googleapis.com/maps/api/staticmap?center=Miami,Fl&zoom=13&markers=Miami,Fl&size=300x300&sensor=true" alt="map"/>
	</div>
	<?php /*
		<div class="col-lg-12">
