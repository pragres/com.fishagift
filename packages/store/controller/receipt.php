...
// @TODO undertand and fix flow-breaker
if (is_null($order)) {
...
$arrivalDate = date("m/d/Y", mktime($order['DATE']));
...
include_once framework::resolve("packages/store/i18n/$lang/receipt.php");
...
// calling the view
include_once framework::resolve('packages/store/view/receipt.tpl');
